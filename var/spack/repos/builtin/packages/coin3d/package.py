...
class Coin3d(AutotoolsPackage, CMakePackage):
    ...
    depends_on("libsm", type="link", when="platform=linux")
    depends_on("libxext", type="link", when="platform=linux")
    depends_on("libice", type="link", when="platform=linux")
    depends_on("uuid", type="link")
    depends_on("libxcb", type="link", when="platform=linux")
    depends_on("libxau", type="link", when="platform=linux")
